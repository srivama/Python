...
seven(number)
isOdd(number)
gad(number1, number2) // greatest common divisor
kg(number1, number2) // least common multiple
...
factorial (n) // n!
Fib (n) // calculate the nth Fibonacci term.
...
def getPrimeNumbers(N):
    """
     ...
     This function is more efficient as function 'sieve Er(...)'
    """    
...
def goldbach(number):
    """
     ...
     input: an even positive integer 'number' > 2
...
def getPrime(n):
    """
     ...
     returns the nth prime number, beginning at index 0
    """    
    # precondition
...
def simplifyFraction(numerator, denominator):
    """
     ...
     returns: a duple with simplify numerator and denominator.
    """      
...
def fib(n):
    """
     input: positive integer 'n'
     returns the nth Fibonacci term, indexing by 0
    """  
